...
if($_SERVER['REQUEST_METHOD']=='POST')
{
	...
	$jabatan=$_POST['jabatan'];
		...
		$test="SELECT * FROM karyawan WHERE nik = '$nik' OR nama='$nama'";
		...
		if ($result ==0) {
			...
			$simpan="INSERT INTO karyawan(nik,nama,tempat_lahir,tgl_lahir,alamat,kelamin,agama,status,pendidikan,jabatan) VALUES('$nik','$nama','$tmplahir','$tgllahir','$alamat','$kelamin','$agama','$status','$pdd','$jabatan')";
